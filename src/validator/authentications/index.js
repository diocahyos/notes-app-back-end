...
const AuthencticationValidator = {
  ...
  validatorPutAuthenticationPayload: (payload) => {
    const validationResult = PutAuthenticationPayloadSchema.validate(payload)
    if (validationResult.error) {
      throw new InvariantError(validationResult.error.message)
    }
  },
  validatorDeleteAuthenticationPayload: (payload) => {
...
module.exports = AuthencticationValidator
